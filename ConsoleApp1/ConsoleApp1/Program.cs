...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //int decrement;
            //bool isdecrement = int.TryParse(Console.ReadLine(), out decrement);

            //for (int n = decrement; n >= 1; n--)
            //{
            //    Console.WriteLine(n);
            //}
            ...
            //for (int n = 1; n <= converted; n++)
            //{
            //    if (n % 2 != 0)         //ova so izvicnikot go pronajdov na google 
            //        Console.WriteLine(n);
            //}
